-- A3 FINANCE V1.3.2 CARDINALITY-SAFE COMPLETE INSTALLER
-- Corrects PostgreSQL ERROR 21000 by avoiding installation-time multi-row
-- ON CONFLICT DO UPDATE statements. Safe after a partial V1.3.1 run.
