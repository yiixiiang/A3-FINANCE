...
import styles from "./driver-signup.module.css";
    ...
    return (
      <main className={styles.successPage} style={theme}>
        <section className={styles.successCard}>
          ...
          <p className={styles.smallText}>The company will review your contact, vehicle, emergency, bank, PayNow and uploaded document information. This submission does not create a login account automatically.</p>
        </section>
      </main>
    );
  }
      ...
      <div className={styles.content}>
        <aside className={styles.sidebar}>
          <section>
            ...
            <p>Provide your name, contact, car, emergency contact, bank, PayNow and vehicle documents. Your application goes only to the selected company.</p>
          </section>
        ...
        <form className={styles.formCard} onSubmit={submit}>
          ...
          <section className={styles.formSection}>
            ...
            <div className={styles.formGrid}>
              ...
              <label><span>Email Address</span><input type="email" placeholder="Optional" value={form.contact_email} onChange={(event) => update("contact_email", event.target.value)} /></label>
              <label><span>NRIC / FIN / Passport</span><input value={form.nric_passport} onChange={(event) => update("nric_passport", event.target.value)} /></label>
          ...
          <section className={styles.formSection}>
            <div className={styles.sectionTitle}><span>03</span><div><h2>Driving Licence</h2><p>Licence information helps the company complete verification.</p></div></div>
            <div className={styles.formGrid}>
              <label><span>Licence Number</span><input value={form.licence_no} onChange={(event) => update("licence_no", event.target.value)} /></label>
              <label><span>Licence Class</span><input placeholder="Example: Class 3A" value={form.licence_class} onChange={(event) => update("licence_class", event.target.value)} /></label>
              <label><span>Licence Expiry</span><input type="date" value={form.licence_expiry} onChange={(event) => update("licence_expiry", event.target.value)} /></label>
            </div>
          </section>

          <section className={styles.formSection}>
            <div className={styles.sectionTitle}><span>04</span><div><h2>Upload Vehicle Files *</h2><p>Upload log card, insurance, inspection report or clear vehicle photos.</p></div></div>
          ...
          <section className={styles.formSection}>
            <div className={styles.sectionTitle}><span>05</span><div><h2>Emergency Contact, Bank & PayNow</h2><p>Required emergency and payout information for approved drivers.</p></div></div>
            <div className={styles.formGrid}>
              ...
              <label><span>PayNow Type *</span><select required value={form.paynow_type} onChange={(event) => update("paynow_type", event.target.value)}><option value="mobile">Mobile</option><option value="nric">NRIC / FIN</option><option value="uen">UEN</option><option value="other">Other</option></select></label>
