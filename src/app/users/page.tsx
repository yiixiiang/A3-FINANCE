        ...
        <div className="actions page-heading-row">
          <div>
            ...
            <p className="subtitle">
              Create login accounts for your assigned companies, control roles and reset passwords.
            </p>
          </div>
              ...
              <article className="card">
                <div className="actions company-access-heading">
                  <div>
                    ...
                    <p className="subtitle">Every account, including administrators, only sees its assigned companies.</p>
                  </div>
