...
const nav: {label:string;items:Item[]}[]=[
 ...
 {label:"Fleet & Settings",items:[{id:"ratemanagement",label:"Limousine Management",icon:Settings2},{id:"clientsetup",label:"Client Management",icon:Users},{id:"catalogue",label:"Website Catalogue",icon:Globe2},{id:"company",label:"Company Management",icon:Settings2},{id:"cloud",label:"Cloud & Backup",icon:Database},{id:"access",label:"User Access",icon:ShieldCheck}]},
