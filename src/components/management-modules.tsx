...
type AdditionalCharge={id:string;code:string;name:string;chargeType:"Fixed"|"Per Hour"|"Per Stop"|"Per Seat"|"Actual Cost";amount:number;description:string;status:"Active"|"Inactive";displayOrder:number};
