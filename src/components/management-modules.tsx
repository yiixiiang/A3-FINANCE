...
const chargeDefaults:AdditionalCharge[]=[
 {id:"CHG-001",code:"MIDNIGHT",name:"Midnight surcharge",chargeType:"Fixed",amount:20,description:"Applies to journeys between 23:00 and 06:30.",status:"Active",displayOrder:1},
 {id:"CHG-002",code:"WAITING",name:"Waiting time",chargeType:"Per Hour",amount:30,description:"Charged after the complimentary waiting period.",status:"Active",displayOrder:2},
 {id:"CHG-003",code:"EXTRA_STOP",name:"Additional stop",chargeType:"Per Stop",amount:15,description:"For each extra stop requested after confirmation.",status:"Active",displayOrder:3},
 {id:"CHG-004",code:"CHILD_SEAT",name:"Child seat",chargeType:"Per Seat",amount:15,description:"Subject to availability and advance request.",status:"Active",displayOrder:4},
 {id:"CHG-005",code:"ERP_PARKING",name:"ERP, tolls and parking",chargeType:"Actual Cost",amount:0,description:"Reimbursed at actual cost where applicable.",status:"Active",displayOrder:5}
];
